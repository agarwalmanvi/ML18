...
run_trial(stat_par,stat_par_reweigh,disp_imp,disp_imp_reweigh,eq_opp_diff,eq_opp_diff_reweigh,avg_odds_diff,avg_odds_diff_reweigh,theil, theil_reweigh, acc, acc_reweigh):
